    ...
    <>
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-white/90 backdrop-blur-md border border-gray-200 shadow-lg">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-300/30 to-gray-400/30 rounded-full blur opacity-50"></div>

          {isMobile ? (
            <div className="relative flex items-center justify-between">
              <Link href="/" className="font-bold text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-700 to-gray-900">Alex</span>
                <span className="text-gray-900">Chen</span>
              </Link>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-900 hover:to-gray-700 border-0"
              >
                Resume
              </Button>
            </div>
      ...
      {isMobile && (
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <Button className="mt-6 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-900 hover:to-gray-700 border-0">
              Resume
            </Button>
          </div>
        </motion.div>
